                ...
                .addOnCompleteListener { task ->
                    if(task.isSuccessful) {
                        ...
                        if(userId != null) {
                            ...
                            firestore.collection("users").document(userId) // nisam siguran jel ovo valja, isprobati, uspjesno registrira, jos provjeriti jel doda uspjesno u kolekciju
                                .set(userMap)


                            Toast.makeText(context, "Registered successfully", Toast.LENGTH_SHORT).show()
                            val currentUser = getCurrentUser()
                            Log.d("user id", currentUser.toString())
